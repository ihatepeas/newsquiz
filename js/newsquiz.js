...
(function($) {
	...
	var right_answers = 0;
		...
		console.log(right_answers);
                ...
                how_you_did_element.append(jQuery('<span> Good Job! You got </span>'));
		...
		if (right_answers == 0){
		    $("#quiz_reply").html("<h3 class='red'>Sorry, none correct.</h3>")
		    
		}
		
		if  (right_answers == 1){
		    $("#quiz_reply").html("keep trying")
		}
		
		if  (right_answers == 5){
		    $("#quiz_reply").html("<h3 class='blue'> You are so average.</h3>")
		}
		
		
		if  (right_answers == 7){
		    $("#quiz_reply").html("B- status!")
		}
